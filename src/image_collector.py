...
class Google(object):
    ...
    def image_search(self, query_gen, maximum):
        ...
        while True:
            ...
            image_url_list = [e.get('src') for e in elements]
...
def main(tag,num):
    ...
    print(google.query_gen(target_name))
